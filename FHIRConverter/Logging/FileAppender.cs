...
namespace FHIRConverter.Logging
{
    ...
    public class FileAppender : TextWriterAppender
    {
        ...
        override public void ActivateOptions()
        {
            ...
            {
                LogLog.Warn(typeof(RollingFileAppender), "FileAppender: File option not set for appender [" + Name + "].");
                LogLog.Warn(typeof(RollingFileAppender), "FileAppender: Are you using FileAppender instead of ConsoleAppender?");
            }
        }
